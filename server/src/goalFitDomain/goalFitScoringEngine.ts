import type {
  ...
  RiskTagCount,
  RoleType
} from "./goalFitTypes.js";
import { companyEntryWeights, companyMotivationFit, companyRolePairScore, DEFAULT_COMPANY_SCORE, DEFAULT_PAIR_SCORE, DEFAULT_ROLE_SCORE, motivationTagPriority, roleEntryWeights, roleMotivationFit, SCORE_VERSION } from "./goalFitScoringConfig.js";
import { selectGoalFitQuestions } from "./goalFitQuestionSelector.js";
